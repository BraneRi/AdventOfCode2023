...
function processFile(filePath) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var fileStream, rl, nodeRegex, nodes, moves, startingNodes, _d, rl_1, rl_1_1, line, match, start, left, right, e_1_1, startingNodesArray, currentStep, steps, i, startNode;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 12:
                    startingNodesArray = Array.from(startingNodes.entries());
                    steps = [];
                    for (i = 0; i < startingNodesArray.length; i++) {
                        startNode = startingNodesArray[i];
                        currentStep = getNextAligned(nodes.get(startNode[0]), nodes, moves, startNode[1]);
...
function findLowestCommonDenominator(numbers) {
    ...
    var lcmOfArray = function (arr) { return arr.reduce(function (acc, num) { return lcm(acc, num); }, 1); };
    return lcmOfArray(numbers);
}
function getNextAligned(currentNode, nodes, moves, steps) {
    var nextMove = 0;
