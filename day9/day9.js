...
function processFile(filePath) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var fileStream, rl, sum, series, _d, rl_1, rl_1_1, line, e_1_1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    _d = false;
                    line = _c;
                    series = line.split(" ").map(function (item) { return Number(item); });
                    // console.log(series);
...
function calculateNextItem(series, allZeroes) {
    if (allZeroes) {
        return 0;
    }
    var tempSeries = [];
