...
function processFile(filePath) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var fileStream, rl, sum, firstDigit, lastDigit, startCharSequence, endCharSequence, charFromStart, charFromEnd, _d, rl_1, rl_1_1, line, i, containsStartNumber, containsEndNumber, e_1_1;
            ...
            switch (_e.label) {
                ...
                case 3:
                    ...
                    for (i = 0; i < line.length; i++) {
                        ...
                        containsStartNumber = validCharDigitSequences.find(function (substring) {
                            return new RegExp(substring.key).test(startCharSequence);
                        });
                        containsEndNumber = validCharDigitSequences.find(function (substring) {
                            return new RegExp(substring.key).test(endCharSequence);
                        });
