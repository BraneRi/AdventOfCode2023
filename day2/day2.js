...
var fs = require("fs");
var regexRed = /(\d+) red/;
var regexGreen = /(\d+) green/;
var regexBlue = /(\d+) blue/;
function processFile(filePath) {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function () {
        var fileStream, rl, sum, redMax, greenMax, blueMax, _d, rl_1, rl_1_1, line, lineParts, _i, lineParts_1, section, redMatch, greenMatch, blueMatch, e_1_1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    greenMax = 0;
                    blueMax = 0;
                    for (_i = 0, lineParts_1 = lineParts; _i < lineParts_1.length; _i++) {
                        section = lineParts_1[_i];
                        redMatch = section.match(regexRed);
                        if (redMatch && parseInt(redMatch[1], 10) > redMax) {
                            redMax = parseInt(redMatch[1], 10);
                        }
                        greenMatch = section.match(regexGreen);
                        if (greenMatch && parseInt(greenMatch[1], 10) > greenMax) {
                            greenMax = parseInt(greenMatch[1], 10);
                        }
                        blueMatch = section.match(regexBlue);
